<?php
    ...
    $imgfilepath = "E:/Claudio/Progetti/2019/2019-01-19008-THRoadshow/new_web_app/2019-01-19008-throadshow-new_web_app/userimages/image.jpg";
    ...
    $outputpath = "E:/Claudio/Progetti/2019/2019-01-19008-THRoadshow/new_web_app/2019-01-19008-throadshow-new_web_app/userimages/output.txt";
    ...
    if($string == "glasses"){
        $perc = floatval(fgets($outputfile));
        if($perc < 0.85){
            $string = fgets($outputfile);
            fclose($outputfile);
            unlink($outputpath);
